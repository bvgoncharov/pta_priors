...
class EPTAModels(StandardModels):
  ...
  def __init__(self,psr=None,params=None):
    ...
    self.priors.update({
      ...
      "event_j1713_1_t0": [54650., 54850.],
      "event_j1713_2_t0": [57490., 57530.],
  ...
  def j1713_event_1(self, option="exp_dip"):
    return dm_exponential_dip(self.params.event_j1713_1_t0[0],
                              self.params.event_j1713_1_t0[1], idx=4.,
  ...
  def j1713_event_2(self, option="exp_dip"):
    return dm_exponential_dip(self.params.event_j1713_2_t0[0],
                              self.params.event_j1713_2_t0[1], idx=1.,
...
def dm_exponential_dip(tmin, tmax, idx=2, sign='negative', name='dmexp',
                       lgA_min=-6., lgA_max=-5., sign_min=-1., sign_max=1.,
                       tau_min_10_pow=5, tau_max_10_pow=100):
...
#def gamma_constraint(parameters):
#  parameters['gamma_con'] = np.abs(parameters['gamma_sn'] - 4.33) - np.abs(parameters['gamma_cp'] - 4.33)
#  return parameters
